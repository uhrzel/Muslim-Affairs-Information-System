            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex items-center justify-between px-4 py-4 bg-white border-b dark:bg-gray-800 dark:border-gray-700 sm:px-6">
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('admin.logsShow', $report->id) }}" class="text-blue-400 hover:text-blue-600 underline dark:text-blue-300 dark:hover:text-blue-400">
                            Back
                        </a>
                    </div>
                </div>

                <form action="{{ route('admin.logsUpdate', $report->id) }}" method="POST">
                    @csrf
                    @method('PUT')
