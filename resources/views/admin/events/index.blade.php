    ...
    <x-slot name="header">
        <div class="flex  items-center">
            ...
            <div class="mr-4"> <!-- Adjust the margin as needed -->
                <a href="{{ route('admin.eventsCreate') }}" class="inline-flex items-center bg-blue-500 hover:bg-blue-600 text-white rounded-full px-4 py-2 leading-none text-sm ">
                    ...
                    <table class="w-full text-sm text-left text-black">
                        ...
                        <tbody id="searchResults">
                            ...
                            <tr class="border-b border-gray-500 bg-gray-200 hover:bg-gray-300" style="font-family: 'Arial', sans-serif;">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.eventsShow', $Events->id) }}" class="w-24 inline-block bg-blue-600 text-white rounded-full px-4 py-2 leading-none hover:bg-blue-800">
