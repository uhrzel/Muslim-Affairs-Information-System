    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="bg-gray-800 text-white py-4 px-6 text-lg font-semibold uppercase">401 Unauthorized</div>

                <div class="p-6">
                    <p class="text-gray-700">{{ __('Sorry, you are not authorized to access this page.') }}</p>
