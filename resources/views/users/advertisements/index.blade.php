            ...
            <div class="bg-blue-600 overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-6 text-white">
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        @endif
                        <div>
                            <p class="text-base font-bold event-title">{{ $event->event_name }}</p>
                            <p class="text-sm text-gray-300">Event Date: {{ $event->event_date }}</p>
                            <p class="text-sm text-gray-300">Event Time: {{ $event->event_time }}</p>
                        </div>
                    </div>
                    @endif
                    @empty
            ...
            <div class="bg-green-600 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <div class="relative mb-6 mr-4 overflow-hidden bg-no-repeat shadow-lg dark:shadow-black/20 news-image-container" data-te-ripple-init data-te-ripple-color="light">
                        ...
                        <div>
                            <p class="text-base font-bold news-title">{{ $singleNews->news_title }}</p>
                            <p class="text-sm text-gray-300"> News Date: {{ $singleNews->news_date }}</p>
                            <p class="text-sm text-gray-300"> News Time: {{ $singleNews->news_time }}</p>
                        </div>
                    </div>
