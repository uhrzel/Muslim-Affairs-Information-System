...
<body class="bg-green-fullscreen">
    ...
    <main class="flex flex-col justify-center items-center">
        ...
        <section class="text-center md:text-left">
            ...
            <div class="mb-6 flex flex-wrap mt-10">
                ...
                <div class="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12 news-item">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-300 news-content">
        ...
        <script>
            ...
            <p class="mb-6 text-gray-800">
                <small>News Date: <u>${date}</u></small> <br>
                <small>News Time: <u>${time}</u></small>
            </p>
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="max-w-sm mb-6 mr-4">
                    ...
                    <p class="text-neutral-500 dark:text-neutral-300">
                        <small>Event Date: <u>{{ $Event->event_date }}</u></small><br>
                        <small>Event Time: <u>{{ $Event->event_time }}</u></small>
                    </p>
                    <p class="text-neutral-500 dark:text-neutral-300">
        ...
        <script>
            ...
            <img src="${imageSrc}" class="w-full mb-4 rounded-lg">
            <p class="mb-6 text-gray-800">
                <small>Event Date: <u>${date}</u></small> <br>
                <small>Event Time: <u>${time}</u></small>
            </p>
            <p class="text-gray-800">
        ...
        <footer class="text-center text-neutral-600 dark:text-neutral-200 lg:text-left">
            <div class="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
                ...
                <div class="flex justify-center">
                    <a href="https://web.facebook.com/muslimaffairs.mce" class="mr-6 text-neutral-600 dark:text-neutral-200 social-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                        </svg>
                    </a>
                    <a href="#!" class="mr-6 text-neutral-600 dark:text-neutral-200 social-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://github.com/uhrzel" class="text-neutral-600 dark:text-neutral-200 social-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mx-6 py-10 text-center md:text-left">
                <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="">
                        <h6 class="mb-4 flex justify-center font-semibold uppercase md:justify-start partnership-title">
                            Partnership
                        </h6>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200 partnership-title">LGU/PLDU - South Cotabato
                            </a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200 partnership-title">None Government Organization (NGO)</a>
                        </p>
                        <p class="mb-4">
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200 partnership-title">PNP</a>
                        </p>
                        <p>
                            <a href="#!" class="text-neutral-600 dark:text-neutral-200 partnership-title">SF-PA</a>
                        </p>
                    </div>
                    <!-- Useful links section -->
                    <div class="">
                        <h6 class="mb-4 flex justify-center font-semibold uppercase md:justify-start useful-links-title">
                            Useful links
                        </h6>
                        <p class="mb-4">
                            <a href="https://web.facebook.com/muslimaffairs.mce" class="text-neutral-600 dark:text-neutral-200 useful-links-title">Facebook</a>
                        </p>
                        <p class="mb-4">
                            <a href="#" class="text-neutral-600 dark:text-neutral-200 useful-links-title">Youtube</a>
                        </p>
                        <p class=" mb-4">
                            <a href="mailto:maoInfoSys@gmail.com" class="text-neutral-600 dark:text-neutral-200 useful-links-title">Gmail</a>
                        </p>
                        <p>
                            <a href="#" class="text-neutral-600 dark:text-neutral-200 useful-links-title">Linkedin</a>
                        </p>
                    </div>

                    <div>
                        <h6 class="mb-4 flex justify-center font-semibold uppercase md:justify-start contact-title">
                            Contact
                        </h6>
                        <p class="mb-4 flex items-center justify-center md:justify-start contact-title">
